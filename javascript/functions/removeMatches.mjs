...
function removeMatches(numberOfMatchesToRemove) {
    ...
    if (gameStateVariables.numberOfMatchesRemaining - numberOfMatchesToRemove < 0) {
    ...
    console.log(`There are ${gameStateVariables.numberOfMatchesRemaining} matches remaining.`);
